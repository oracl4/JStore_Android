...
public class OrderRecyclerViewAdapter extends RecyclerView.Adapter<OrderRecyclerViewAdapter.OrderViewHolder> {
    ...
    public void onBindViewHolder(@NonNull OrderViewHolder orderViewHolder, int i) {
        ...
        orderViewHolder.tvItem.setText(invoices.get(i).getItems()+"");
        ...
        String itemName=invoices.get(i).getItems().toString();
        ...
        orderViewHolder.layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("item_name", invoice.getItems().toString());
                ...
                else if (invoice.getInvoiceStatus().equals("Unpaid"))
                {
